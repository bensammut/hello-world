...
`,Cu=class{renderer;lowW=320;lowH=180;scale=1;sceneTarget;quantTarget;quantMat;blitMat;quad;postScene=new An;postCam=new Ta(-1,1,1,-1,0,1);constructor(e){this.renderer=new pl({canvas:e,antialias:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.quantMat=new Bi({vertexShader:bu,fragmentShader:xu,uniforms:{tColor:{value:null},tDepth:{value:null},uRes:{value:new G},uPalette:{value:yu()},uDither:{value:vl.dither},uOutline:{value:+!!vl.outline},uNear:{value:1},uFar:{value:1e3}},depthTest:!1,depthWrite:!1}),this.blitMat=new Bi({vertexShader:bu,fragmentShader:Su,uniforms:{tSrc:{value:null},uRes:{value:new G},uScale:{value:1}},depthTest:!1,depthWrite:!1}),this.quad=new Jr(new ji(2,2),this.quantMat),this.quad.frustumCulled=!1,this.postScene.add(this.quad)}set dither(e){this.quantMat.uniforms.uDither.value=e?vl.dither:0}set outline(e){this.quantMat.uniforms.uOutline.value=+!!e}resize(e,t,n){this.renderer.setSize(e,t,!1);let i=this.renderer.getPixelRatio(),a=Math.max(1,Math.floor(e*i)),o=Math.max(1,Math.floor(t*i));this.scale=Math.max(1,Math.round(o/vl.targetRows)),this.lowW=Math.ceil(a/this.scale),this.lowH=Math.ceil(o/this.scale),this.sceneTarget?.dispose(),this.quantTarget?.dispose();let s={minFilter:r,magFilter:r,generateMipmaps:!1};this.sceneTarget=new Wt(this.lowW,this.lowH,{...s,depthTexture:new Ti(this.lowW,this.lowH)}),this.quantTarget=new Wt(this.lowW,this.lowH,{...s,depthBuffer:!1}),n.aspect=this.lowW/this.lowH,n.updateProjectionMatrix()}render(e,t){let n=this.renderer;n.setRenderTarget(this.sceneTarget),n.render(e,t);let r=this.quantMat.uniforms;r.tColor.value=this.sceneTarget.texture,r.tDepth.value=this.sceneTarget.depthTexture,r.uRes.value.set(this.lowW,this.lowH),r.uNear.value=t.near,r.uFar.value=t.far,this.quad.material=this.quantMat,n.setRenderTarget(this.quantTarget),n.render(this.postScene,this.postCam);let i=this.blitMat.uniforms;i.tSrc.value=this.quantTarget.texture,i.uRes.value.set(this.lowW,this.lowH),i.uScale.value=this.scale,this.quad.material=this.blitMat,n.setRenderTarget(null),n.render(this.postScene,this.postCam)}},wu=class{state;listeners=new Set;constructor(){let e=Sl[0];this.state={toolId:e.id,diameterIndex:Object.fromEntries(Sl.map(e=>[e.id,e.defaultDiameter])),depth:1.5,rpm:e.rpm,feed:e.feed,plungeMode:!1,soundOn:!1,helpOpen:!1,camera:`iso`,status:`READY`,stats:{removedMm3:0,cutTime:0,toolChanges:0,strokes:0},undoDepth:0,redoDepth:0}}subscribe(e){return this.listeners.add(e),e(this.state),()=>this.listeners.delete(e)}set(e){Object.assign(this.state,e),this.emit()}emit(){for(let e of this.listeners)e(this.state)}},Tu=(e,t)=>new G(e,t);function Eu(e,t,n,r){let i=t/2,a=e=>Math.tan(e/2*Math.PI/180);switch(e.id){case`flat`:return[Tu(0,n),Tu(i,n),Tu(i,r),Tu(0,r)];case`ball`:{let e=[Tu(0,n),Tu(i,n),Tu(i,r+i)];for(let t=1;t<=6;t++){let n=t/6*(Math.PI/2);e.push(Tu(i*Math.cos(n),r+i-i*Math.sin(n)))}return e}case`vbit`:{let t=i/a(e.coneDeg??90);return[Tu(0,n),Tu(i,n),Tu(i,r+t),Tu(0,r)]}case`drill`:{let t=i/a(e.coneDeg??118);return[Tu(0,n),Tu(i,n),Tu(i,r+t),Tu(0,r)]}case`engrave`:{let t=1.5,i=1.42/a(e.coneDeg??30);return[Tu(0,n),Tu(t,n),Tu(t,r+i),Tu(.08,r),Tu(0,r)]}case`face`:return[Tu(0,n),Tu(i,n),Tu(i,r),Tu(0,r)]}}function Du(e,t,n,r){let i=new Ai(e,12).toNonIndexed(),a=i.getAttribute(`position`),o=new Float32Array(a.count*3),s=new Y(n),c=new Y(r),l=Math.max(2,t*2);for(let e=0;e<a.count;e+=3){let t=0,n=0,r=0;for(let i=0;i<3;i++)t+=a.getX(e+i),n+=a.getY(e+i),r+=a.getZ(e+i);let i=Math.atan2(r,t)+Math.PI+n*.22,u=(Math.floor(i/(Math.PI*2)*l)%2+2)%2==0?s:c;for(let t=0;t<3;t++)u.toArray(o,(e+t)*3)}return i.setAttribute(`color`,new lr(o,3)),i.computeVertexNormals(),i}var Ou=e=>new Ui({color:e}),ku=new Map;function Au(e){let t=ku.get(e);return t||ku.set(e,t=Ou(e)),t}var ju=new Ui({vertexColors:!0});function Mu(e,t){let n=new Sn;n.name=`tool-${e.id}`;let r=e.stickout,i=Tl.rack.ringHeight,a=new Jr(new ki(10,10,i,12),Au(e.color));a.position.y=-i/2,a.name=`holder`,n.add(a);let o=new Jr(new ki(9,7,7,6),Au(Q.steelLight));o.position.y=-i-3.5,o.name=`holder`,n.add(o);let s=-i-7,c=t/2,l=e.id===`face`?9:Math.min(e.maxDepth+4,r+s-3),u=-r+l,d=e.id===`face`?8:e.id===`engrave`?1.5:Math.max(c,1.5),f=u-s;if(f<-.01){let e=new Jr(new ki(d,d,-f,10),Au(Q.steel));e.position.y=(s+u)/2,n.add(e)}let p=new Jr(Du(Eu(e,t,u,-r),e.flutes,Q.steelLight,Q.carbide),ju);if(n.add(p),e.id===`face`)for(let t=0;t<e.flutes;t++){let i=t/e.flutes*Math.PI*2,a=new Jr(new Oi(3,3,3),Au(`#ffe07a`));a.position.set(Math.cos(i)*(c-1.2),-r+1.5,Math.sin(i)*(c-1.2)),a.rotation.y=-i,n.add(a)}return n}function Nu(e){e.traverse(e=>{e instanceof Jr&&e.geometry.dispose()})}var Pu={k:`#0b0d12`,s:`#eef2f8`,m:`#a3adc2`,d:`#667086`,y:`#ffe07a`,a:`#f6a33c`,g:`#8cff6e`,r:`#ff5a4e`,b:`#7fdcff`,w:`#ffffff`},Fu=[`..kkkkkkkk..`,`..khhhhhhk..`,`..kkkkkkkk..`],Iu={flat:[...Fu,`...kmssdk...`,`...kmssdk...`,`...kmssdk...`,`...ksmdsk...`,`...kdsmsk...`,`...ksmdsk...`,`...kdsmsk...`,`...ksmdsk...`,`...kdsmsk...`,`...ksmdsk...`,`...kkkkkk...`,`............`,`............`],ball:[...Fu,`...kmssdk...`,`...kmssdk...`,`...kmssdk...`,`...ksmdsk...`,`...kdsmsk...`,`...ksmdsk...`,`...kdsmsk...`,`...ksmdsk...`,`...kdsmsk...`,`....kddk....`,`.....kk.....`,`............`,`............`],vbit:[...Fu,`....kmsk....`,`....kmsk....`,`....kmsk....`,`....kmsk....`,`..kkkkkkkk..`,`..kssmmddk..`,`...ksmmdk...`,`....ksdk....`,`.....kk.....`,`............`,`............`,`............`,`............`],drill:[...Fu,`....kmsk....`,`....ksdk....`,`....kmsk....`,`....kdsk....`,`....kmsk....`,`....ksdk....`,`....kmsk....`,`....kdsk....`,`....kmsk....`,`....ksdk....`,`.....kk.....`,`............`,`............`],face:[...Fu,`....kmsk....`,`....kmsk....`,`kkkkkkkkkkkk`,`kmssssssssdk`,`kmsssmmsssdk`,`kyddyddyddyk`,`kkkkkkkkkkkk`,`............`,`............`,`............`,`............`,`............`,`............`],engrave:[...Fu,`....kmsk....`,`....kmsk....`,`....kmsk....`,`....kmsk....`,`....kmsk....`,`....ksdk....`,`.....kk.....`,`.....kk.....`,`.....kk.....`,`......k.....`,`............`,`............`,`............`]},Lu={speakerOn:[`....k.......`,`...kk...a...`,`kkkmk..a.a..`,`kssmk....a..`,`kssmk.a..a..`,`kssmk....a..`,`kkkmk..a.a..`,`...kk...a...`,`....k.......`],speakerOff:[`....k.......`,`...kk.......`,`kkkmk.r...r.`,`kssmk..r.r..`,`kssmk...r...`,`kssmk..r.r..`,`kkkmk.r...r.`,`...kk.......`,`....k.......`],logo:[`..kkkkkkkk..`,`..kaaaaaak..`,`..kkkkkkkk..`,`....kmsk....`,`....ksdk....`,`....kmsk....`,`.....kk.....`,`............`,`k.k.k.k.k.k.`,`kmmmmmmmmmmk`,`kddddddddddk`,`kkkkkkkkkkkk`],blower:[`kkkkk.......`,`kmssk..b.b..`,`kmsskkb.b.b.`,`kmsssss.b.b.`,`kmsskkb.b.b.`,`kmssk..b.b..`,`kkkkk.......`,`..kk........`,`..kk........`]};function Ru(e,t,n=`#f6a33c`){let r=e.length,i=e[0].length,a=``;for(let t=0;t<r;t++)for(let r=0;r<i;r++){let i=e[t][r];if(i===`.`||i===void 0)continue;let o=i===`h`?n:Pu[i];o&&(a+=`<rect x="${r}" y="${t}" width="1.02" height="1.02" fill="${o}"/>`)}return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${i} ${r}" width="${i*t}" height="${r*t}" shape-rendering="crispEdges">${a}</svg>`}function zu(e,t,n=3){return Ru(Iu[e],n,t)}var Bu=(e,t)=>e.querySelector(t),Vu=(e,t=1)=>e.toFixed(t),Hu=(e,t)=>String(Math.round(e)).padStart(t,` `);function Uu(e){let t=Math.floor(e/60),n=Math.floor(e%60);return`${String(t).padStart(2,`0`)}:${String(n).padStart(2,`0`)}`}var Wu=[[`LMB DRAG`,`Move tool / cut`],[`SHIFT+DRAG`,`Lock to a straight line (X or Y)`],[`WHEEL`,`Depth (0.5 mm steps)`],[`SPACE`,`Toggle plunge mode`],[`ARROWS`,`Jog tool along X / Y (relative to the view)`],[`SHIFT+ARROWS`,`Fine jog`],[`ENTER (HOLD)`,`Lower tool to depth / cut, like holding LMB`],[`R`,`Retract tool`],[`RMB DRAG / ALT+DRAG`,`Orbit camera`],[`MMB DRAG / ALT+SHIFT+DRAG`,`Pan camera`],[`CTRL+WHEEL / PINCH`,`Zoom`],[`1 - 6`,`Select tool (auto tool change)`],[`[  ]`,`Tool diameter down / up`],[`- / =`,`Depth up / down`],[`T F S I`,`Camera: top / front / side / iso`],[`CTRL+Z`,`Undo stroke`],[`CTRL+SHIFT+Z / CTRL+Y`,`Redo`],[`CTRL+S / CTRL+O`,`Save / open project`],[`B`,`Blow off chips`],[`M`,`Sound on / off`],[`?`,`This help`]],Gu=class{root;warnEl;toastEl;toastTimer=0;depthTag;live={};fileInput;act;constructor(e,t,n){this.act=n,this.root=e,e.innerHTML=this.markup(),this.warnEl=Bu(e,`#warn`),this.toastEl=Bu(e,`#toast`),this.depthTag=Bu(e,`#depth-tag`),this.fileInput=Bu(e,`#file-input`);for(let t of e.querySelectorAll(`[data-live]`))this.live[t.dataset.live]=t;this.bind(),t.subscribe(e=>this.render(e))}markup(){let e=Sl.map(e=>`
      <li><button class="slot" data-tool="${e.id}" title="${e.name} — ${e.blurb} (key ${e.slot})">
        <span class="key">${e.slot}</span>
        <span class="icon">${zu(e.id,e.color,3)}</span>
        <span class="info"><b>${e.short}</b><i data-dia="${e.id}"></i></span>
      </button></li>`).join(``),t=[`top`,`front`,`side`,`iso`].map(e=>`<button data-cam="${e}">${e.toUpperCase()}</button>`).join(``),n=Wu.map(([e,t])=>`<tr><th>${e}</th><td>${t}</td></tr>`).join(``),r=Dl.map(e=>`<button type="button" data-preset="${e.mm.join(`,`)}">${e.name}<small>${e.mm[0]}×${e.mm[2]}×${e.mm[1]}</small></button>`).join(``);return`
    <header class="panel topbar">
      <div class="brand">${Ru(Lu.logo,3)}<div><h1>PIXEL MILL</h1><small>PM-3 HIGH SPEED VOXEL MILL</small></div></div>
      <nav>
    ...
    <aside class="panel hud">
      ...
      <div class="hud-buttons">
        ...
        <button data-act="blow" title="Blow off chips (B)">${Ru(Lu.blower,2)} BLOW CHIPS</button>
      </div>
    </aside>
    ...
    `}bind(){let e=this.root;e.addEventListener(`click`,e=>{let t=e.target.closest(`button`);if(t){if(t.blur(),t.dataset.tool)return this.act.selectTool(t.dataset.tool);if(t.dataset.cam)return this.act.camera(t.dataset.cam);if(t.dataset.preset){let[e,n,r]=t.dataset.preset.split(`,`).map(Number);this.fillStockForm(e,n,r);return}switch(t.dataset.act){case`new`:return this.openNewStock();case`open`:return this.fileInput.click();case`save`:return this.act.save();case`stl`:return this.act.exportStl();case`undo`:return this.act.undo();case`redo`:return this.act.redo();case`sound`:return this.act.toggleSound();case`help`:return this.act.toggleHelp();case`help-close`:return this.act.toggleHelp(!1);case`newstock-close`:return this.closeNewStock();case`dia-`:return this.act.stepDiameter(-1);case`dia+`:return this.act.stepDiameter(1);case`plunge`:return this.act.togglePlunge();case`blow`:return this.act.blowChips()}}}),e.addEventListener(`input`,e=>{let t=e.target,n=Number(t.value);t.dataset.input===`depth`?this.act.setDepth(n):t.dataset.input===`feed`?this.act.setFeed(n):t.dataset.input===`rpm`&&this.act.setRpm(n)}),e.addEventListener(`change`,e=>e.target.blur?.()),Bu(e,`#newstock-form`).addEventListener(`submit`,e=>{e.preventDefault();let t=e.target,n=e=>Number(t.elements.namedItem(e).value);this.act.newStock([n(`x`),n(`y`),n(`z`)]),this.closeNewStock()}),this.fileInput.addEventListener(`change`,()=>{let e=this.fileInput.files?.[0];e&&this.act.open(e),this.fileInput.value=``});for(let t of[`#help`,`#newstock`])Bu(e,t).addEventListener(`pointerdown`,e=>{e.target===e.currentTarget&&(t===`#help`?this.act.toggleHelp(!1):this.closeNewStock())})}fillStockForm(e,t,n){let r=Bu(this.root,`#newstock-form`);r.elements.namedItem(`x`).value=String(e),r.elements.namedItem(`y`).value=String(t),r.elements.namedItem(`z`).value=String(n)}openNewStock(){let[e,t,n]=this.act.currentStockMm();this.fillStockForm(e,t,n),Bu(this.root,`#newstock`).hidden=!1}closeNewStock(){Bu(this.root,`#newstock`).hidden=!0}get dialogOpen(){return!Bu(this.root,`#newstock`).hidden}render(e){let t=Cl[e.toolId],n=t.diameters[e.diameterIndex[e.toolId]];for(let t of this.root.querySelectorAll(`.slot`))t.classList.toggle(`active`,t.dataset.tool===e.toolId);for(let t of Sl){let n=this.root.querySelector(`[data-dia="${t.id}"]`);n&&(n.textContent=`Ø${Vu(t.diameters[e.diameterIndex[t.id]])}`)}let r=this.live;r.dia.textContent=`Ø ${Vu(n)} MM`,r.blurb.textContent=`${t.name}: ${t.blurb}. Max depth ${t.maxDepth} mm.${t.coneDeg?` ${t.coneDeg}° tip.`:``}`,r.tool.textContent=`T${t.slot} ${t.name}`,r.toolDia.textContent=`${Vu(n)} MM  ${t.flutes}FL`,r.depth.textContent=Vu(e.depth),r.feedSet.textContent=String(e.feed),r.rpmSet.textContent=String(e.rpm),r.mode.textContent=t.plungeOnly?`DRILL CYCLE`:e.plungeMode?`PLUNGE`:`CONTOUR`,r.plunge.textContent=e.plungeMode?`PLUNGE ON [SPC]`:`PLUNGE OFF [SPC]`,r.plunge.classList.toggle(`on`,e.plungeMode),r.soundLabel.textContent=e.soundOn?`SOUND ON`:`SOUND OFF`,r.soundIcon.innerHTML=Ru(e.soundOn?Lu.speakerOn:Lu.speakerOff,2),r.undo.textContent=String(e.undoDepth),r.redo.textContent=String(e.redoDepth),r.removed.textContent=Vu(e.stats.removedMm3/1e3,2),r.cutTime.textContent=Uu(e.stats.cutTime),r.toolChanges.textContent=String(e.stats.toolChanges),r.strokes.textContent=String(e.stats.strokes);let[i,a,o]=this.act.currentStockMm();r.stock.textContent=`${i}×${o}×${a}`;let s=Bu(this.root,`[data-input="depth"]`);s.max=String(this.act.maxDepth()),s.value=String(e.depth),Bu(this.root,`[data-input="feed"]`).value=String(e.feed),Bu(this.root,`[data-input="rpm"]`).value=String(e.rpm);for(let t of this.root.querySelectorAll(`[data-cam]`))t.classList.toggle(`active`,t.dataset.cam===e.camera);Bu(this.root,`#help`).hidden=!e.helpOpen}updateLive(e,t){let n=this.live,r=e.status===`TOOL CHANGE`?`TOOL CHG ${Math.round(t.changeProgress*100)}%`:e.status;n.status.textContent=r,n.status.dataset.state=e.status,n.rpm.textContent=`${Hu(t.rpm,5)} RPM`,n.rpmBar.style.width=`${Math.min(100,t.rpm/wl.rpm.max*100)}%`,n.feed.textContent=`${Hu(t.feed,4)} MM/MIN`,n.x.textContent=`${t.x>=0?`+`:``}${Vu(t.x,2)}`,n.y.textContent=`${t.y>=0?`+`:``}${Vu(t.y,2)}`,n.z.textContent=`${t.z>=0?`+`:``}${Vu(t.z,2)}`,n.width.textContent=`${Vu(t.cutWidth,2)} MM CUT`,n.chips.textContent=String(t.chips),n.fps.textContent=`${Math.round(t.fps)} FPS`}showDepthTag(e,t,n,r){this.depthTag.hidden=!r,r&&(this.depthTag.style.transform=`translate(${Math.round(e)+14}px, ${Math.round(t)-22}px)`,this.depthTag.textContent=n)}flashWarning(e){this.live.warnText.textContent=e,this.warnEl.classList.remove(`show`),this.warnEl.offsetWidth,this.warnEl.classList.add(`show`)}toast(e,t=`ok`){this.toastEl.textContent=e,this.toastEl.dataset.kind=t,this.toastEl.classList.add(`show`),clearTimeout(this.toastTimer),this.toastTimer=window.setTimeout(()=>this.toastEl.classList.remove(`show`),2600)}};function Ku(e,t,n){let[r,i,a]=e.chunkCoords(t),o=[r*16,i*16,a*16],s=[Math.min(16,e.dims.x-o[0]),Math.min(16,e.dims.y-o[1]),Math.min(16,e.dims.z-o[2])],c=[],l=[],u=[],d=[],f=[],p=[0,0,0],m=new Uint8Array(256);for(let t=0;t<3;t++){let r=(t+1)%3,i=(t+2)%3,a=s[r],h=s[i];for(let g=1;g>=-1;g-=2)for(let _=0;_<s[t];_++){let s=!1;for(let n=0;n<h;n++)for(let c=0;c<a;c++){p[t]=o[t]+_,p[r]=o[r]+c,p[i]=o[i]+n;let l=e.get(p[0],p[1],p[2]),u=0;l!==0&&(p[t]+=g,e.get(p[0],p[1],p[2])===0&&(u=l)),m[c+n*a]=u,u&&(s=!0)}if(!s)continue;let v=o[t]+_+ +(g>0);for(let e=0;e<h;e++)for(let s=0;s<a;){let p=m[s+e*a];if(!p){s++;continue}let _=1;for(;s+_<a&&m[s+_+e*a]===p;)_++;let y=1;grow:for(;e+y<h;){for(let t=0;t<_;t++)if(m[s+t+(e+y)*a]!==p)break grow;y++}for(let t=0;t<y;t++)for(let n=0;n<_;n++)m[s+n+(e+t)*a]=0;qu(c,l,u,f,t,r,i,v,o[r]+s,o[i]+e,_,y,g,n[p]);let b=+(p===2);d.push(b,b,b,b),s+=_}}}return f.length===0?null:{positions:new Float32Array(c),normals:new Float32Array(l),colors:new Float32Array(u),cut:new Float32Array(d),indices:new Uint32Array(f)}}function qu(e,t,n,r,i,a,o,s,c,l,u,d,f,p){let m=e.length/3,h=(r,u)=>{let d=[0,0,0];d[i]=s,d[a]=c+r,d[o]=l+u,e.push(d[0],d[1],d[2]);let m=[0,0,0];m[i]=f,t.push(m[0],m[1],m[2]),n.push(p[0],p[1],p[2])};f>0?(h(0,0),h(u,0),h(u,d),h(0,d)):(h(0,0),h(0,d),h(u,d),h(u,0)),r.push(m,m+1,m+2,m,m+2,m+3)}function Ju(e){let t=new Y(e);return[t.r,t.g,t.b]}var Yu=class{group=new Sn;meshes=new Map;material;colors=[[0,0,0],Ju(Q.stock),Ju(Q.stockCut)];grid;lastRemeshCount=0;lastRemeshMs=0;depthUniforms={uTop:{value:0},uRange:{value:14}};constructor(e){this.grid=e,this.material=new Hi({vertexColors:!0,specular:new Y(`#5a6273`),shininess:38}),this.material.onBeforeCompile=e=>{Object.assign(e.uniforms,this.depthUniforms),e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
